...
},{"@babel/runtime/helpers/esm/objectSpread2":"node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"src/redux/actionTypes.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TOGGLE_TODO = exports.REMOVE_TODO = exports.ADD_TODO = void 0;
...
},{}],"src/redux/reducer.js":[function(require,module,exports) {
"use strict";
...
function reducer() {
  ...
  var updatedTodos = state.todos.slice();
...
var store = (0, _redux.legacy_createStore)(_reducer.default);
var _default = store;
exports.default = _default;
},{"redux":"node_modules/redux/es/redux.js","./reducer":"src/redux/reducer.js"}],"src/components/todo/index.js":[function(require,module,exports) {
"use strict";
...
var input = document.querySelector(".todo-title");
...
function render() {
  ...
  var todos = _store.default.getState().todos;

  todosList.innerHTML = "";
  todos.forEach(function (el, index) {
    var li = document.createElement("li");
    var btnDelete = createBtnDelete(index);
    var checkBox = createCheckbox(index);
    li.innerHTML = "<span>".concat(el.title, "</span>");
  ...
  document.querySelector(".total-todos").innerHTML = _store.default.getState()["totalTodo"];
}

render();

_store.default.subscribe(render);
},{"../../redux/store":"src/redux/store.js","../../redux/actionTypes":"src/redux/actionTypes.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

require("./components/todo");
},{"./components/todo":"src/components/todo/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
